...
public:
	...
	// acces la atributele private
	// pentru ca cout nu face parte din clasa Magazin
	// ostream& -- pentru a facilita apelul in cascada
...
// istream& - faciliteaza apelul in cascada
// Magazin& - faciliteaza modificarea in main()
...
void main() {
	...
	//indexarea vectorului salarii

	// supraincarcarea operatorului de indexare se face ca metoda , membra a clasei
	try {
		cout << endl << m2[1];
		m2[1] = 200;
		cout << endl << m2[1];
